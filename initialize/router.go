...
func Routers() *gin.Engine {
	...
	chatGptRouter := router.RouterGroupApp.ChatGpt
	annimeVideoRouter := router.RouterGroupApp.AnimeVideo
	...
	//PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		chatGptRouter.InitGptRouter(ApiGroup) // chatGpt相关

		annimeVideoRouter.InitAnimeRouter(ApiGroup) // 动画相关
